    ...
    <div>
        ...
        <div class="familymovie-area relative">
            <Swiper :options="familyMoviesOption">
                <Swiper-Slide v-for="(product, Index) in familyMovies" :key="Index">
                    <SingleProduct 
                        :product="product" 
                        :PageLink="'/movie'"
                        :btnLink="'/movie'"
...
export default {
    ...
    data () {
        return {
            ...
            familyMoviesOption: {
                ...
                spaceBetween: 40,
                navigation: {
                    nextEl: '.familymovie-area .nextbtn',
                    prevEl: '.familymovie-area .prevbtn'
                },
                breakpoints: {
                    1680: {
                        slidesPerView: 6,
    ...
    mounted () {
        this.familyMovies = this.movieData.filter(product=> product.certification == "A")
    }
}
</script>
