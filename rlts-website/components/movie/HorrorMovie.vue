<template>
    <div>
        <SectionTitle
            ...
            title="Horror Movies"
        />
        <div class="horror-movie relative">
            <Swiper :options="movieSeriesOption">
                <Swiper-Slide v-for="(product, Index) in movieSeries" :key="Index">
                    <SingleProduct 
                        :product="product"
                        :PageLink="'/movie'"
                        :btnLink="'/movie'"
    ...
    data () {
        return {
            ...
            movieSeriesOption: {
                ...
                spaceBetween: 40,
                navigation: {
                    nextEl: '.horror-movie .nextbtn',
                    prevEl: '.horror-movie .prevbtn'
                },
                breakpoints: {
                    1680: {
                        slidesPerView: 6,
