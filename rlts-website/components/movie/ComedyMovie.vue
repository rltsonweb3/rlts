<template>
    <div>
        <SectionTitle
            ...
            title="Comedy Movie"
        />
        <div class="comedy-movie relative">
            <Swiper :options="comedyMovieOption">
                <Swiper-Slide v-for="(product, Index) in comedyMovie" :key="Index">
                    <SingleProduct 
                        :product="product"
                        :PageLink="'/movie'"
                        :btnLink="'/movie'"
...
export default {
    ...
    data () {
        return {
            ...
            comedyMovieOption: {
                ...
                spaceBetween: 40,
                navigation: {
                    nextEl: '.comedy-movie .nextbtn',
                    prevEl: '.comedy-movie .prevbtn'
                },
                breakpoints: {
                    1680: {
                        slidesPerView: 6,
    ...
    mounted () {
        this.comedyMovie = this.movieData.filter(product=> product.category.includes("comedy"))
    }
}
</script>
